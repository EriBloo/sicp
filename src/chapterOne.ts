...
export function sum(term: (x: number) => number, a: number, next: (x: number) => number, b: number): number {
  if (a > b) {
    return 0;
  };
...
export function integral(f: (x: number) => number, a: number, b: number, dx: number): number {
...
export function sumIter(term: (x: number) => number, a: number, next: (x: number) => number, b: number): number {
...
export function product(term: (x: number) => number, a: number, next: (x: number) => number, b: number): number {
  if (a > b) {
    return 1;
  };
...
export function productIter(term: (x: number) => number, a: number, next: (x: number) => number, b: number): number {
  function iter(x: number, result: number): number {
    if (x > b) {
      return result;
    };
...
export function squareOfPrimes(start: number, end: number): number {
  return filteredAccumulate((x, y) => x + y, isPrime, 0, square, start, (x) => x + 1, end);
};
...
export function productOfRelativePrimes(end: number): number {
  ...
  return filteredAccumulate((x, y) => x * y, isRelativePrime, 1, (x) => x, 2, (x) => x + 1, end);
};

export function fixedPoint(f: (x: number) => number, firstGuess: number): number {
...
export function kTermFiniteContinuedFraction(n: (x: number) => number, d: (x: number) => number, k: number): number {
...
export function newtonsTransform(g: (x: number) => number): (x: number) => number {
...
export function nFoldSmooth(f: (x: number) => number, n: number): (x: number) => number {
  if (n === 1) {
    return smooth((x) => f(x));
  };
